...
smsNoSpam5: (m, motive) => `*@${m.sender.split`@`[0]} NO PUEDE USAR COMANDOS DURANTE 2 MINUTOS*\n\n*MOTIVO: ${motive}*`, 
...
//grupos
smsAdd: 'Hola! me presento, soy Nekotina 🐈, soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te unas al grupo, te esperamos con ansias!!', 
