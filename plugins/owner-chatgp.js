...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': 'Nekotina', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': 'Nekotina', 'jpegThumbnail': false}}};
  const teks = `*MENSAJE OFICIAL NEKOTINA*\n*🍀 • 𝙳𝚎:* wa.me/${who.split`@`[0]}\n*📧 • 𝙼𝚎𝚗𝚜𝚊𝚓𝚎:* ${text}`;
