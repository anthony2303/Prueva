...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '𝙈𝙞𝙘𝙝𝙞𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙙𝙤 𝙥𝙤𝙧 𝙍𝙞𝙘𝙝𝙚𝙩𝙩𝙞 𝙮 𝙂𝙚𝙧𝙞𝘿𝙯𝙣', thumbnailUrl: await(await fetch(gataMenu)).buffer(), sourceUrl: accountsgb }}}
...
await conn.reply(m.chat, `${eg}🚀 𝙋𝙍𝙐𝙀𝘽𝘼 𝘿𝙀 𝙑𝙀𝙇𝙊𝘾𝙄𝘿𝘼𝘿...\n🚀 𝙎𝙋𝙀𝙀𝘿 𝙏𝙀𝙎𝙏...`, fkontak, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝙈𝙞𝙘𝙝𝙞𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙙𝙤 𝙥𝙤𝙧 𝙍𝙞𝙘𝙝𝙚𝙩𝙩𝙞 𝙮 𝙂𝙚𝙧𝙞𝘿𝙯𝙣', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}})
...
await conn.sendFile(m.chat, gataImg, 'pp.jpg', caption, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝙈𝙞𝙘𝙝𝙞𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙙𝙤 𝙥𝙤𝙧 𝙍𝙞𝙘𝙝𝙚𝙩𝙩𝙞 𝙮 𝙂𝙚𝙧𝙞𝘿𝙯𝙣', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}})
