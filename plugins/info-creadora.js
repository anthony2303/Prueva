...
description = official[0][0] == String(contact[0]) ? 'Solo temas de Nekotina' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
...
lugar = official[0][0] == String(contact[0]) ? 'MichiBot' : official[1][0] == String(contact[0]) ? 'NEKOTINA' : official[2][0] == String(contact[0]) ? 'NEKOTINA' : official[3][0] == String(contact[0]) ? 'NEKOTINA' : country === '' ? lenguajeGB.smsContacto7() : country
...
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝘽𝙔 𝘼𝙉𝙏𝙃𝙊𝙉𝙔 𝙑𝙀𝙉𝙏𝘼𝙎', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
